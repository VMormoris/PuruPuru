//Modified from https://github.com/VMormoris/GreenTea/blob/master/GreenTea/src/Engine/Core/uuid.cpp
#include "uuid.h"
...
namespace gte {
	...
	[[nodiscard]] bool uuid::operator!=(const uuid& rhs) const noexcept { return memcmp(&mUUID, &rhs.mUUID, sizeof(GUID)) != 0; }
	[[nodiscard]] uuid::operator bool() const noexcept { return memcmp(&mUUID, &null, sizeof(GUID)) != 0; }
